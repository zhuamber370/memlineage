...
const dictionaries: Record<Lang, Dictionary> = {
  en: {
    ...
    "home.subtitle": "Overview tasks, news, knowledge, and changes in one place.",
    ...
    "home.news.recentTitle": "Recent News",
    "home.news.openNews": "Open News",
    "home.news.openDetail": "Open Detail",
    ...
    "knowledge.subtitle": "Manage plain-text knowledge notes with title and body only.",
    ...
    "news.title": "News",
    "news.subtitle": "Manage structured news cards captured by OpenClaw.",
    ...
    "skills.subtitle": "Manage MemLineage skill lifecycle for OpenClaw and Codex on this machine.",
  ...
  zh: {
    ...
    "home.title": "首页看板",
    "home.subtitle": "在一个页面汇总任务、新闻、知识与变更概览。",
    "home.loading": "看板加载中...",
    "home.empty": "暂无记录。",
    "home.error": "分区加载失败",
    ...
    "home.news.recentTitle": "最新新闻",
    "home.news.openNews": "打开新闻",
    "home.news.openDetail": "查看详情",
    "home.news.empty": "暂无最近新闻。",
    ...
    "knowledge.title": "知识",
    "knowledge.subtitle": "以纯文本知识笔记为主，仅保留标题和正文。",
    ...
    "news.title": "新闻",
    "news.subtitle": "管理 OpenClaw 捕获的结构化新闻卡片。",
    "news.loading": "加载新闻中...",
    ...
    "skills.title": "技能管理",
    "skills.subtitle": "在当前机器上管理 OpenClaw 与 Codex 的 MemLineage skill 生命周期。",
