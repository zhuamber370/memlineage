...
const dictionaries: Record<Lang, Dictionary> = {
  en: {
    ...
    "lang.en": "EN",
    "lang.zh": "ZH",
    "shell.tagline": "Local-first agent memory and execution control surface.",

    "home.title": "Agent Workbench",
    "home.subtitle": "Monitor tasks, news, knowledge, and governed changes from one control surface.",
    "home.loading": "Loading dashboard...",
    "home.empty": "No records yet.",
    "home.error": "Failed to load section",
    "home.global.title": "Global Snapshot",
    "home.global.taskTotal": "Task Total",
    "home.global.taskInProgress": "In Progress",
    "home.global.p0InProgress": "P0 In Progress",
    "home.global.proposedChanges": "Proposed Changes",
    "home.global.knowledgeTotal": "Knowledge Total",
    "home.global.newsTotal": "News Total",
    "home.global.taskStatusChart": "Task Status Distribution",
    "home.global.inProgressPriorityChart": "In-Progress Priority Mix",
    "home.chart.empty": "No chart data.",
    "home.tasks.title": "Task Board",
    "home.tasks.blockedCount": "Blocked Tasks",
    "home.tasks.dueTodayCount": "Due Today",
    "home.tasks.focusTitle": "Focus List",
    "home.tasks.openTask": "Open Tasks",
    "home.tasks.openStudio": "Open Studio",
    "home.changes.title": "Changes Board",
    "home.changes.proposedCount": "Proposed",
    "home.changes.latestCommittedAt": "Latest Committed",
    "home.changes.recentTitle": "Recent Proposed",
    "home.changes.openChanges": "Open Changes",
    "home.changes.status.proposed": "Proposed",
    "home.changes.status.committed": "Committed",
    "home.changes.status.rejected": "Rejected",
    "home.knowledge.title": "Knowledge Board",
    "home.knowledge.total": "Knowledge Total",
    "home.knowledge.categoryCount": "Categories",
    "home.knowledge.byCategoryTitle": "Category Breakdown",
    "home.knowledge.categoryChart": "Knowledge Category Distribution",
    "home.knowledge.recentTitle": "Recent Knowledge",
    "home.knowledge.openKnowledge": "Open Knowledge",
    "home.news.title": "News Watchboard",
    "home.news.total": "News Total",
    "home.news.newCount": "New",
    "home.news.trackingCount": "Tracking",
    "home.news.actionedCount": "Actioned",
    "home.news.openNews": "Open News",
    "home.dbSafety.title": "Database Safety",
    "home.dbSafety.subtitle": "Backup download and direct restore (overwrite current DB).",
    "home.dbSafety.backup.title": "Backup",
    "home.dbSafety.backup.action": "Create Backup & Download",
    "home.dbSafety.backup.running": "Backing up...",
    "home.dbSafety.backup.success": "Backup downloaded.",
    "home.dbSafety.backup.failed": "Backup failed",
    "home.dbSafety.restore.title": "Restore",
    "home.dbSafety.restore.pickFile": "Choose Backup File",
    "home.dbSafety.restore.selectedFile": "Selected file",
    "home.dbSafety.restore.warn": "Restore will overwrite the current database immediately.",
    "home.dbSafety.restore.ack": "I understand this will overwrite current data.",
    "home.dbSafety.restore.action": "Restore Now",
    "home.dbSafety.restore.running": "Restoring...",
    "home.dbSafety.restore.confirm": "Confirm restore? This will overwrite current database and cannot be undone.",
    ...
    "tasks.title": "Tasks",
    "tasks.subtitle": "Operate the task queue, then move into the execution studio when work starts.",
    "tasks.total": "Total",
    ...
    "tasks.execution.inspectorEmpty": "Select a node or edge to view logs.",
    ...
    "tasks.execution.logBadge": "Logs",
    "tasks.execution.logPlaceholderNode": "Write a progress log for this node.",
    "tasks.execution.logPlaceholderEdge": "Write a handoff log for this edge.",
    "tasks.execution.addLog": "Add Log",
    "tasks.execution.editLog": "Edit",
    "tasks.execution.saveLog": "Save",
    ...
    "changes.subtitle": "Review proposed writes, inspect diffs, and commit or roll back with intent.",
    ...
    "knowledge.subtitle": "Maintain durable operating knowledge for the agent workspace.",
    "knowledge.create": "Create Item",
    "knowledge.save": "Save",
    "knowledge.archive": "Archive",
    "knowledge.delete": "Delete",
    "knowledge.confirmDelete": "Delete this knowledge item permanently?",
    "knowledge.unclassified": "Unclassified",
    "knowledge.topic": "Topic",
    "knowledge.topicAll": "All Topics",
    "knowledge.type": "Type",
    "knowledge.typeAll": "All Types",
    "knowledge.type.playbook": "Playbook",
    "knowledge.type.decision": "Decision",
    "knowledge.type.brief": "Brief",
    "knowledge.category": "Category",
    "knowledge.categoryAll": "All Categories",
    "knowledge.categoryAuto": "Auto (by rules)",
    "knowledge.category.ops_manual": "Ops Manual",
    "knowledge.category.mechanism_spec": "Mechanism Spec",
    "knowledge.category.decision_record": "Decision Record",
    "knowledge.tags": "Tags",
    "knowledge.updated": "Updated",
    "knowledge.sourceCount": "Evidence",
    "knowledge.sources": "Evidence",
    "knowledge.detail": "Detail",
    "knowledge.statusActive": "Active",
    "knowledge.statusArchived": "Archived",
    "knowledge.readOnlyHint": "Archived knowledge is read-only.",
    "knowledge.emptyList": "No knowledge items in this view.",
    "knowledge.emptyDetail": "Select a knowledge item to view details.",
    "knowledge.noticeCreated": "Knowledge item created.",
    "knowledge.noticeUpdated": "Knowledge item updated.",
    "knowledge.noticeArchived": "Knowledge item archived.",
    "knowledge.noticeDeleted": "Knowledge item deleted.",
    "knowledge.noticeEvidenceAdded": "Evidence added.",
    "knowledge.errValidation": "Required fields are missing.",
    "knowledge.placeholderSearch": "Search title/content",
    ...
    "knowledge.placeholderSourceRef": "source ref",
    "knowledge.placeholderExcerpt": "evidence excerpt",
    "knowledge.placeholderGoal": "Playbook goal",
    "knowledge.placeholderSteps": "One step per line",
    "knowledge.placeholderDecision": "Decision statement",
    "knowledge.placeholderRationale": "Decision rationale",
    "knowledge.placeholderSummary": "Brief summary",
    "knowledge.placeholderHighlights": "One highlight per line",
    "knowledge.titleField": "Title",
    "knowledge.body": "Body",
    "knowledge.goal": "Goal",
    "knowledge.steps": "Steps",
    "knowledge.decision": "Decision",
    "knowledge.rationale": "Rationale",
    "knowledge.summary": "Summary",
    "knowledge.highlights": "Highlights",
    "knowledge.addEvidence": "Add Evidence",

    "news.title": "News",
    "news.subtitle": "Review structured news signals, track status, and clean the stream.",
    "news.loading": "Loading news...",
    "news.searchPlaceholder": "Search title / summary / opportunity / risk",
    "news.filterDate": "Published date",
    "news.filterToday": "Today",
    "news.filterPrevDay": "Previous Day",
    "news.filterNextDay": "Next Day",
    "news.refresh": "Refresh",
    "news.detail": "News Detail",
    "news.updated": "Updated",
    "news.sourceCount": "Sources",
    "news.publishedAt": "Published",
    "news.capturedAt": "Captured",
    "news.save": "Save",
    "news.archive": "Archive",
    "news.delete": "Delete",
    "news.confirmDelete": "Delete this news item permanently?",
    "news.emptyList": "No news items in this view.",
    "news.emptyDetail": "Select a news item to inspect.",
    "news.noticeUpdated": "News item updated.",
    "news.noticeArchived": "News item archived.",
    "news.noticeDeleted": "News item deleted.",
    "news.errValidation": "Required fields are missing.",
    "news.errDatetime": "Published/Captured time is invalid.",
    "news.errRawPayload": "Raw payload must be valid JSON.",
    "news.field.title": "Title",
    "news.field.summary": "Summary",
    "news.field.opportunity": "Opportunity",
    "news.field.risk": "Risk",
    "news.field.status": "Status",
    "news.field.tags": "Tags",
    "news.field.publishedAt": "Published At",
    "news.field.capturedAt": "Captured At",
    "news.field.primarySource": "Primary Source",
    "news.field.referenceSources": "Reference Sources (one URL per line)",
    "news.field.rawPayload": "Raw Payload JSON",
    "news.status.all": "All Statuses",
    "news.status.new": "New",
    "news.status.tracking": "Tracking",
    "news.status.actioned": "Actioned",
    "news.status.archived": "Archived",

    "ideas.title": "Ideas",
    "ideas.subtitle": "Shape raw product or technical ideas before promoting them into executable flow.",
    ...
    "skills.subtitle": "Operate local MemLineage skill runtimes for OpenClaw and Codex on this machine.",
    "skills.localOnly": "Operations run on backend host paths. Use this page only when backend and agent runtime are on the same machine.",
    "skills.refreshAll": "Refresh All",
    "skills.loading": "Loading...",
    "skills.error": "Request failed",
    "skills.agent.openclaw": "OpenClaw",
    "skills.agent.codex": "Codex",
    "skills.section.path": "Path",
    "skills.section.status": "Status",
    "skills.section.manualPath": "Manual Path",
    "skills.section.version": "Version",
    "skills.section.health": "Health",
    "skills.detect.unknown": "Detect: Unknown",
    "skills.detect.ready": "Detect: Ready",
    "skills.detect.failed": "Detect: Failed",
    "skills.runtime.unknown": "Runtime: Unknown",
    "skills.runtime.installed": "Runtime: Installed",
    "skills.runtime.not_installed": "Runtime: Not installed",
    "skills.skill.unknown": "Skill: Unknown",
    "skills.skill.installed": "Skill: Installed",
    "skills.skill.not_installed": "Skill: Not installed",
    "skills.pathMode.none": "No resolved path",
    "skills.pathMode.auto": "Auto-detected",
    "skills.pathMode.manual": "Manual override",
    "skills.status.installed": "Installed",
    "skills.status.notInstalled": "Not installed",
    "skills.status.enabled": "Enabled",
    "skills.status.disabled": "Disabled",
    "skills.version.bundled": "Bundled",
    "skills.version.installed": "Installed",
    "skills.version.unknown": "Unknown",
    "skills.version.updateAvailable": "Update available",
    "skills.version.upToDate": "Up to date",
    "skills.health.ok": "Healthy",
    "skills.health.degraded": "Degraded",
    "skills.health.checks": "Checks",
    "skills.health.warnings": "Warnings",
    "skills.paths.target": "Target",
    "skills.paths.disabled": "Disabled",
    "skills.paths.source": "Source",
    "skills.path.placeholder": "Enter runtime root path",
    "skills.runtimeVersion": "Runtime version",
    "skills.pathSource": "Path source",
    "skills.manualPathSaved": "Manual path saved",
    "skills.manualPathHint": "Auto detection failed. Provide runtime root path, then click Save Path and Detect again.",
    "skills.action.install": "Install",
    "skills.action.reinstall": "Reinstall",
    "skills.action.uninstall": "Uninstall",
    "skills.action.enable": "Enable",
    "skills.action.disable": "Disable",
    "skills.action.savePath": "Save Path",
    "skills.action.detect": "Detect",
    "skills.action.checkHealth": "Check Health",
    "skills.action.update": "Update",
    "skills.action.refresh": "Refresh",
    "skills.confirm.uninstall": "Uninstall this skill from the target runtime?",
    "skills.confirm.disable": "Disable this skill in the target runtime?",
    "skills.confirm.update": "Update this runtime to bundled version?",
    "skills.advancedMode": "Advanced mode (allow force install/update)",
    "skills.lastChecked": "Last checked",
    "skills.lastAction": "Last action",
    "skills.yes": "Yes",
    "skills.no": "No",
    "skills.none": "None",
  ...
  zh: {
    ...
    "lang.en": "EN",
    "lang.zh": "中文",
    "shell.tagline": "本地优先的 agent 记忆与执行控制台。",

    "home.title": "Agent 工作台",
    "home.subtitle": "在一个控制台里观察任务、新闻、知识与受控变更。",
    "home.loading": "看板加载中...",
    "home.empty": "暂无记录。",
    "home.error": "分区加载失败",
    "home.global.title": "全局快照",
    "home.global.taskTotal": "任务总数",
    "home.global.taskInProgress": "进行中任务",
    "home.global.p0InProgress": "P0 进行中",
    "home.global.proposedChanges": "待处理变更",
    "home.global.knowledgeTotal": "知识总数",
    "home.global.newsTotal": "新闻总数",
    "home.global.taskStatusChart": "任务状态分布",
    "home.global.inProgressPriorityChart": "进行中优先级分布",
    "home.chart.empty": "暂无可展示数据。",
    "home.tasks.title": "任务看板",
    "home.tasks.blockedCount": "阻塞任务",
    "home.tasks.dueTodayCount": "今日到期",
    "home.tasks.focusTitle": "焦点列表",
    "home.tasks.openTask": "打开任务",
    "home.tasks.openStudio": "进入执行",
    "home.changes.title": "变更看板",
    "home.changes.proposedCount": "待处理",
    "home.changes.latestCommittedAt": "最近提交",
    "home.changes.recentTitle": "最近提案",
    "home.changes.openChanges": "打开变更",
    "home.changes.status.proposed": "待处理",
    "home.changes.status.committed": "已提交",
    "home.changes.status.rejected": "已拒绝",
    "home.knowledge.title": "知识看板",
    "home.knowledge.total": "知识总数",
    "home.knowledge.categoryCount": "分类数",
    "home.knowledge.byCategoryTitle": "分类分布",
    "home.knowledge.categoryChart": "知识分类分布",
    "home.knowledge.recentTitle": "最近更新",
    "home.knowledge.openKnowledge": "打开知识",
    "home.news.title": "新闻看板",
    "home.news.total": "新闻总数",
    "home.news.newCount": "新增",
    "home.news.trackingCount": "跟踪中",
    "home.news.actionedCount": "已处理",
    "home.news.openNews": "打开新闻",
    "home.dbSafety.title": "数据库安全",
    "home.dbSafety.subtitle": "下载备份并直接恢复（覆盖当前数据库）。",
    "home.dbSafety.backup.title": "备份",
    "home.dbSafety.backup.action": "创建并下载备份",
    "home.dbSafety.backup.running": "备份中...",
    "home.dbSafety.backup.success": "备份已下载。",
    "home.dbSafety.backup.failed": "备份失败",
    "home.dbSafety.restore.title": "恢复",
    "home.dbSafety.restore.pickFile": "选择备份文件",
    "home.dbSafety.restore.selectedFile": "已选文件",
    "home.dbSafety.restore.warn": "恢复会立即覆盖当前数据库。",
    "home.dbSafety.restore.ack": "我已知晓这将覆盖当前数据。",
    "home.dbSafety.restore.action": "立即恢复",
    "home.dbSafety.restore.running": "恢复中...",
    "home.dbSafety.restore.confirm": "确认恢复？该操作会覆盖当前数据库且不可撤销。",
    ...
    "tasks.title": "任务",
    "tasks.subtitle": "先管理任务队列，再在执行 Studio 中推进工作。",
    "tasks.total": "总数",
    ...
    "tasks.execution.inspectorEmpty": "选择节点或连线后可查看日志。",
    ...
    "tasks.execution.logBadge": "日志",
    "tasks.execution.logPlaceholderNode": "为该节点写一条执行日志。",
    "tasks.execution.logPlaceholderEdge": "为该连线写一条衔接日志。",
    "tasks.execution.addLog": "新增日志",
    "tasks.execution.editLog": "编辑",
    "tasks.execution.saveLog": "保存",
    ...
    "changes.title": "变更",
    "changes.subtitle": "审阅提案写入、检查差异，并按意图提交或回滚。",
    ...
    "knowledge.title": "知识",
    "knowledge.subtitle": "维护面向 agent 工作台的长期操作知识。",
    "knowledge.create": "创建知识",
    "knowledge.save": "保存",
    "knowledge.archive": "归档",
    "knowledge.delete": "删除",
    "knowledge.confirmDelete": "确定永久删除该知识条目吗？",
    "knowledge.unclassified": "未归类",
    "knowledge.topic": "主题",
    "knowledge.topicAll": "全部主题",
    "knowledge.type": "类型",
    "knowledge.typeAll": "全部类型",
    "knowledge.type.playbook": "执行手册",
    "knowledge.type.decision": "决策",
    "knowledge.type.brief": "简报",
    "knowledge.category": "分类",
    "knowledge.categoryAll": "全部分类",
    "knowledge.categoryAuto": "自动分类（按规则）",
    "knowledge.category.ops_manual": "操作手册",
    "knowledge.category.mechanism_spec": "机制与规范",
    "knowledge.category.decision_record": "决策记录",
    "knowledge.tags": "标签",
    "knowledge.updated": "更新时间",
    "knowledge.sourceCount": "证据数",
    "knowledge.sources": "证据",
    "knowledge.detail": "详情",
    "knowledge.statusActive": "生效中",
    "knowledge.statusArchived": "已归档",
    "knowledge.readOnlyHint": "归档知识仅可查看。",
    "knowledge.emptyList": "当前视图暂无知识条目。",
    "knowledge.emptyDetail": "请选择一条知识查看详情。",
    "knowledge.noticeCreated": "知识条目已创建。",
    "knowledge.noticeUpdated": "知识条目已更新。",
    "knowledge.noticeArchived": "知识条目已归档。",
    "knowledge.noticeDeleted": "知识条目已删除。",
    "knowledge.noticeEvidenceAdded": "证据已追加。",
    "knowledge.errValidation": "存在必填字段未填写。",
    "knowledge.placeholderSearch": "搜索标题或内容",
    "knowledge.placeholderBody": "正文",
    "knowledge.placeholderTag": "按标签筛选",
    "knowledge.placeholderTitle": "标题",
    "knowledge.placeholderTags": "标签1, 标签2",
    "knowledge.placeholderSourceRef": "来源引用",
    "knowledge.placeholderExcerpt": "证据摘录",
    "knowledge.placeholderGoal": "执行目标",
    "knowledge.placeholderSteps": "每行一个步骤",
    "knowledge.placeholderDecision": "决策结论",
    "knowledge.placeholderRationale": "决策依据",
    "knowledge.placeholderSummary": "简报摘要",
    "knowledge.placeholderHighlights": "每行一个要点",
    "knowledge.titleField": "标题",
    "knowledge.body": "正文",
    "knowledge.goal": "目标",
    "knowledge.steps": "步骤",
    "knowledge.decision": "结论",
    "knowledge.rationale": "依据",
    "knowledge.summary": "摘要",
    "knowledge.highlights": "要点",
    "knowledge.addEvidence": "追加证据",

    "news.title": "新闻",
    "news.subtitle": "审阅结构化新闻信号、跟踪状态并清理信息流。",
    "news.loading": "加载新闻中...",
    "news.searchPlaceholder": "搜索标题 / 摘要 / 机会点 / 风险点",
    "news.filterDate": "发布日期",
    "news.filterToday": "今日",
    "news.filterPrevDay": "上一日",
    "news.filterNextDay": "下一日",
    "news.refresh": "刷新",
    "news.detail": "新闻详情",
    "news.updated": "更新时间",
    "news.sourceCount": "来源数",
    "news.publishedAt": "发布时间",
    "news.capturedAt": "捕获时间",
    "news.save": "保存",
    "news.archive": "归档",
    "news.delete": "删除",
    "news.confirmDelete": "确定永久删除这条新闻吗？",
    "news.emptyList": "当前视图暂无新闻。",
    "news.emptyDetail": "请选择一条新闻查看详情。",
    "news.noticeUpdated": "新闻已更新。",
    "news.noticeArchived": "新闻已归档。",
    "news.noticeDeleted": "新闻已删除。",
    "news.errValidation": "必填字段未填写完整。",
    "news.errDatetime": "发布时间或捕获时间格式不正确。",
    "news.errRawPayload": "原始载荷必须是合法 JSON。",
    "news.field.title": "标题",
    "news.field.summary": "摘要",
    "news.field.opportunity": "机会点",
    "news.field.risk": "风险点",
    "news.field.status": "状态",
    "news.field.tags": "标签",
    "news.field.publishedAt": "发布时间",
    "news.field.capturedAt": "捕获时间",
    "news.field.primarySource": "主来源",
    "news.field.referenceSources": "参考来源（每行一个 URL）",
    "news.field.rawPayload": "原始载荷 JSON",
    "news.status.all": "全部状态",
    "news.status.new": "新入库",
    "news.status.tracking": "跟踪中",
    "news.status.actioned": "已分流",
    "news.status.archived": "已归档",

    "ideas.title": "想法",
    "ideas.subtitle": "先打磨产品/技术想法，再把就绪内容提升为可执行流程。",
    "ideas.create": "创建想法",
    "ideas.refresh": "刷新",
    ...
    "skills.title": "技能管理",
    "skills.subtitle": "在当前机器上操作 OpenClaw 与 Codex 的本地 MemLineage skill 运行时。",
    "skills.localOnly": "操作会直接作用在后端所在机器的本地路径。仅在后端与 agent 运行在同一台机器时使用。",
    "skills.refreshAll": "全部刷新",
    "skills.loading": "加载中...",
    "skills.error": "请求失败",
    "skills.agent.openclaw": "OpenClaw",
    "skills.agent.codex": "Codex",
    "skills.section.path": "路径",
    "skills.section.status": "状态",
    "skills.section.manualPath": "手动路径",
    "skills.section.version": "版本",
    "skills.section.health": "健康",
    "skills.detect.unknown": "检测：未知",
    "skills.detect.ready": "检测：就绪",
    "skills.detect.failed": "检测：失败",
    "skills.runtime.unknown": "运行时：未知",
    "skills.runtime.installed": "运行时：已安装",
    "skills.runtime.not_installed": "运行时：未安装",
    "skills.skill.unknown": "Skill：未知",
    "skills.skill.installed": "Skill：已安装",
    "skills.skill.not_installed": "Skill：未安装",
    "skills.pathMode.none": "未解析路径",
    "skills.pathMode.auto": "自动检测",
    "skills.pathMode.manual": "手动路径",
    "skills.status.installed": "已安装",
    "skills.status.notInstalled": "未安装",
    "skills.status.enabled": "已启用",
    "skills.status.disabled": "已禁用",
    "skills.version.bundled": "仓库版本",
    "skills.version.installed": "已安装版本",
    "skills.version.unknown": "未知",
    "skills.version.updateAvailable": "有可用更新",
    "skills.version.upToDate": "已是最新",
    "skills.health.ok": "健康",
    "skills.health.degraded": "降级",
    "skills.health.checks": "检查项",
    "skills.health.warnings": "告警",
    "skills.paths.target": "目标路径",
    "skills.paths.disabled": "禁用路径",
    "skills.paths.source": "来源路径",
    "skills.path.placeholder": "输入运行时根路径",
    "skills.runtimeVersion": "运行时版本",
    "skills.pathSource": "路径来源",
    "skills.manualPathSaved": "已保存手动路径",
    "skills.manualPathHint": "自动检测失败。请填写运行时根路径，保存后再次点击检测。",
    "skills.action.install": "安装",
    "skills.action.reinstall": "重装",
    "skills.action.uninstall": "卸载",
    "skills.action.enable": "启用",
    "skills.action.disable": "禁用",
    "skills.action.savePath": "保存路径",
    "skills.action.detect": "检测",
    "skills.action.checkHealth": "健康检查",
    "skills.action.update": "更新",
    "skills.action.refresh": "刷新",
    "skills.confirm.uninstall": "确认从目标运行时卸载该 skill？",
    "skills.confirm.disable": "确认在目标运行时禁用该 skill？",
    "skills.confirm.update": "确认把目标运行时更新到仓库版本？",
    "skills.advancedMode": "高级模式（允许强制安装/更新）",
    "skills.lastChecked": "最近检测",
    "skills.lastAction": "最近操作",
    "skills.yes": "是",
    "skills.no": "否",
    "skills.none": "无",
